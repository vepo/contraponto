...
public class I18nMessageCatalog {
    ...
    private static final Map<String, String> PT_BR_DEFAULTS = Map.ofEntries(
                                                                            ...
                                                                            Map.entry(I18nKeys.TOAST_POST_RESPONSE_PENDING, I18nDefaults.POST_RESPONSE_PENDING),
                                                                            Map.entry(I18nKeys.TOAST_READING_LIST_SAVED, I18nDefaults.READING_LIST_SAVED),
                                                                            Map.entry(I18nKeys.TOAST_READING_LIST_ALREADY_SAVED,
                                                                                      I18nDefaults.READING_LIST_ALREADY_SAVED),
                                                                            Map.entry(I18nKeys.TOAST_READING_LIST_MARKED_READ,
                                                                                      I18nDefaults.READING_LIST_MARKED_READ),
                                                                            Map.entry(I18nKeys.TOAST_READING_LIST_MARKED_UNREAD,
                                                                                      I18nDefaults.READING_LIST_MARKED_UNREAD),
                                                                            Map.entry(I18nKeys.TOAST_READING_LIST_REMOVED, I18nDefaults.READING_LIST_REMOVED),
                                                                            Map.entry(I18nKeys.TOAST_READING_LIST_LIMIT_REACHED,
                                                                                      I18nDefaults.READING_LIST_LIMIT_REACHED),
