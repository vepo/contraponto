...
public final class YoutubeContentRenderPlugin implements ContentRenderPlugin {
    ...
    public String render(List<String> params) {
        ...
        return """
               ...
               <iframe src="https://www.youtube.com/embed/%s" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
               </div>
               """.formatted(id)
                  .trim();
    }
