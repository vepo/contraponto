...
| [src/test/resources/docker-smoke/README.md](src/test/resources/docker-smoke/README.md) | CI/local prod-faithful smoke stack (sync with `contraponto-prod`) |
